// Package runtime provides a reusable agent runtime over provider-neutral models.
//
...
// # Stream semantics
//
// runtime.Stream is a run-level lifecycle stream, not a decorator or alias of
