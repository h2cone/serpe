...
func decodeUsage(usage *usageWire) models.Usage {
	...
	if usage.InputTokens != nil {
		result.InputTokens = models.Some(*usage.InputTokens)
	}
	if usage.OutputTokens != nil {
		result.OutputTokens = models.Some(*usage.OutputTokens)
	}
	if usage.TotalTokens != nil {
		result.TotalTokens = models.Some(*usage.TotalTokens)
	}
	if usage.InputTokensDetails.CachedTokens != nil {
		result.CachedInputTokens = models.Some(*usage.InputTokensDetails.CachedTokens)
	}
	if usage.OutputTokensDetails.ReasoningTokens != nil {
		result.ReasoningTokens = models.Some(*usage.OutputTokensDetails.ReasoningTokens)
	}
